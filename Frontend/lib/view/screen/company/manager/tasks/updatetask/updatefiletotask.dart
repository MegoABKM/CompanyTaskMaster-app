...
class UpdateFileToTask extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<UpdatefilefortaskController>(
      init: UpdatefilefortaskController(),
      builder: (controller) {
        return Scaffold(
          appBar: AppBar(
            title: Text(
              '316'.tr, // Update Task Files
                        ...
                        Center(
                          child: Column(
                            ...
                            children: [
                              ...
                              ElevatedButton(
                                onPressed: controller.goToViewDetails,
  ...
  String _formatDate(String? date) {
    if (date == null) return "318".tr; // N/A
  ...
  void _openAttachment(BuildContext context, AttachmentModel attachment,
      UpdatefilefortaskController controller) {
  ...
  void _showEditDialog(BuildContext context, AttachmentModel attachment,
      UpdatefilefortaskController controller, ScaleConfig scaleConfig, theme) {
