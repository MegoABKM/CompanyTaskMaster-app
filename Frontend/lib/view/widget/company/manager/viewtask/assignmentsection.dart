...
class AssignedUsersSection extends GetView<ViewTaskCompanyManagerController> {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        // The edit button is now in the AppBar of the parent screen
        Text(
            ...
            ? ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return AssignedUserCard(
                      user: user, theme: theme, scaleConfig: scaleConfig);
                },
              )
            : Padding(
    ...
    return Card(
      ...
      child: ListTile(
        ...
        leading: CircleAvatar(
          ...
          child: Text(user.usersName?[0].toUpperCase() ?? "U",
              style: TextStyle(
                  color: theme.colorScheme.primary,
                  fontWeight: FontWeight.bold,
                  fontSize: scaleConfig.scaleText(16))),
        ),
        title: Text(user.usersName ?? "318".tr,
        ...
        subtitle: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text("330".tr + " ${user.usersPhone ?? "318".tr}",
                style: theme.textTheme.bodyMedium
                    ?.copyWith(fontSize: scaleConfig.scaleText(14))),
            Text("331".tr + " ${user.usersEmail ?? "318".tr}",
                style: theme.textTheme.bodyMedium
                    ?.copyWith(fontSize: scaleConfig.scaleText(14))),
          ],
        ),
