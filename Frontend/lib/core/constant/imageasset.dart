class AppImageAsset {
  ...
  static const String onBoardingImageOne = "$rootImages/companyhome.jpeg";
  ...
  static const String onBoardingImageFive = "$rootImages/onboardingfive.json";
  static const String servererror = "$rootImages/server.json";
  ...
  static const String edittask = "$rootImages/edittask.json";
  static const String teamwork = "$rootImages/teamwork.png";
  static const String loginimage = "$rootImages/companyhome.jpeg";
  static const String managerimage = "$rootImages/managerpage.jpg";
  static const String loading = "$rootImages/loading.json";
  static const String loading2 = "$rootImages/loading2.json";
  static const String laugnauge = "$rootImages/laungauge.json";
  static const String colorize = "$rootImages/onboardingsix.json";
}
